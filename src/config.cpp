...
const float correctionPercent = 0.45f;  // Небольшая поправка (0.4f=40%) положения стрелки в ключевом моменте корректировки
...
int tailAngle = 30;           // Угол ухода привода из под молоточка (20 - ночной режим, 25-30 - стандартный бой)
