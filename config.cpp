...
int StepsForMinute = 686; // Одна минута в полушаговом режиме = теоритически 690 шагов
...
const int idealPosition = 686;  // Микрик срабатывает за столько шагов до деления
const int minimalCorrectionMinutes = 1; // минимальное отставание/опережение для коррекции
